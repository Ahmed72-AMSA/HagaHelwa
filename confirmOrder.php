...
foreach($_SESSION["cart"] as $cart){
    if(isset($_SESSION["products"][$cart]["title"])){
    echo $_SESSION["products"][$cart]["title"];
    }
}
...
if(isset($_POST["submit"])){
    ...
    $pdf->Cell(35 ,5,$_SESSION['userName'],4,1);//end of line
    ...
    $pdf->Cell(34 ,5,'price of a piece',1,1);//end of line
    ...
    foreach($_SESSION["cart"] as $cart){
    if(isset($_SESSION['products'][$cart]['title'])){
    $pdf->Cell(130 ,5,$_SESSION['products'][$cart]['title'],1,0);
    $pdf->Cell(25 ,5,$_SESSION['products'][$cart]['quantity'],1,0);
    
    $pdf->Cell(34 ,5,$_SESSION['products'][$cart]['price'],1,1,'R');//end of line
    }
}
    ...
    $pdf->Cell(4 ,5,'$',1,0);
    $pdf->Cell(30 ,5,$_SESSION["total"],1,1,'R');//end of line
